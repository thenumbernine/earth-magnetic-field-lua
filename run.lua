...
local GLReduce = require 'earth-magnetic-field.reduce'
...
--]]
	...
	for j=0,latdim-1 do
		...
		for i=0,thislondim-1 do
			...
			local Bx, By, Bz = W:calcB(phi, lambda, height0)
...
function App:updateGUI()
	...
	if ig.igBeginMainMenuBar() then
		if ig.igBeginMenu'quakes:' then
			...
			if ig.luatableSliderFloat('years from '..tostring(W.wmm.epoch), guivars, 'fieldDT', -50, 50) then
